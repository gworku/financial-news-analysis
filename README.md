...
yfinance – Reliable API for fetching historical stock market data

TA-Lib – Industry-standard library for calculating technical indicators

NLTK – Powerful toolkit for natural language processing and sentiment analysis
